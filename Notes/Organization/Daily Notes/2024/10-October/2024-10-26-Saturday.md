...
<< [[Organization/Daily Notes/2024/10-October/2024-10-25-Friday|Yesterday]] | [[Organization/Daily Notes/2024/10-October/2024-10-27-Sunday|Tomorrow]] >>
...
### Notes created today
```dataview
List FROM "" WHERE file.cday = date("2024-10-26") SORT file.ctime asc
```
