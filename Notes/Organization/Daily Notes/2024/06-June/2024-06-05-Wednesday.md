...
<< [[Organization/Daily Notes/2024/06-June/2024-06-04-Tuesday|Yesterday]] | [[Organization/Daily Notes/2024/06-June/2024-06-06-Thursday|Tomorrow]] >>
...
### Notes created today
```dataview
List FROM "" WHERE file.cday = date("2024-06-05") SORT file.ctime asc
```
