...
<< [[Organization/Daily Notes/2024/06-June/2024-06-03-Monday|Yesterday]] | [[Organization/Daily Notes/2024/06-June/2024-06-05-Wednesday|Tomorrow]] >>
...
- [x] Write daily notes
- [x] Repeat learned stuff
- [x] 8:00-10:00 MIT learn
- [x] 12:00-18:00 FZI Programming
...
### Notes created today
```dataview
List FROM "" WHERE file.cday = date("2024-06-04") SORT file.ctime asc
```
