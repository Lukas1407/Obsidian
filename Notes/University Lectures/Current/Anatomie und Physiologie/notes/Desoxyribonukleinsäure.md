...
- -> Die DNA ist flexibel genug, um eine Base aus der Doppelhelix herauszudrehen, während der Rest der Helix stabil bleibt.
- Wenn eine Base herausgeklappt ist, wird sie für bestimmte Enzyme zugänglich
	- Z.b. für Reperatur-Enzyme
- Prozess benötigt nur wenig Energie
...
- Die A DNA hat 10 BP
- Die Z DNA 12 BP
- -> deswegen hat eine Windung ca. 10.5 BP
...
- Diese Stapelung (genannt stacking interactions) ist energetisch günstig und trägt zur Stabilität der DNA bei.
...
- Führt dazu, dass die hydrophoben Bereiche der Basen stärker übereinander liegen, somit erhöht die bessere Überlappung der Basen die hydrophobe Wechselwirkung zwischen benachbarten Basen
#### ![[Calladine-Clash]]
### Krümmung der DNA
...
- **G-C-Paare** neigen dazu, stärkere Wechselwirkungen (drei Wasserstoffbrücken) zu bilden als **A-T-Paare** (zwei Wasserstoffbrücken), was die lokale Stabilität und Steifheit der DNA beeinflusst.
- Einige Sequenzen, wie AT-reiche Bereiche, neigen dazu, flexibler zu sein und ermöglichen stärkere Biegungen der DNA.
- GC-reiche Bereiche sind steifer, was zu einer weniger flexiblen Struktur führt.
![[Pasted image 20241024122143.png#invert|300]]
- A-T Bereiche biegen sich in Richtung der kleinen Furche, G-C Bereiche entgegengesetzt
...
- Das ist aber ein Problem z.B. bei der Transkription und Replikation, da die Spannung immer größer wird je weiter die DNA Polymerase geht
### Transkription/Replikation erzeugt positive und negative Superhelikalität
...
- **Vor** der Polymerase, wo sie die DNA noch nicht passiert hat, wird die DNA **positiv** superhelikal, weil die Bewegung der Polymerase das Verdrillen der DNA fördert. Es entsteht Spannung, weil die Polymerase die DNA "zusammenzieht", indem sie die Stränge trennt.
- **Hinter** der Polymerase, wo sie bereits durchgelaufen ist, bleibt die DNA in einem entdrillten Zustand, was zur **negativen Superhelikalität** führt. Hier wurde die Spannung, die ursprünglich durch die Helixstruktur vorhanden war, durch das Fortschreiten der Polymerase und das Aufdrehen der DNA verringert.
![[Pasted image 20241024123319.png#invert|400]]
### Ausgleich der Torsion
#### Topoisomerase Typ I:
- **Funktion**: Topoisomerase I entwirrt die DNA, indem sie **einen Einzelstrang** der DNA schneidet.
- **Mechanismus**:
    - Die Topoisomerase Typ I schneidet einen der beiden Stränge der DNA-Doppelhelix.
    - Dadurch kann der nicht geschnittene Strang frei um den geschnittenen rotieren, was die Torsionsspannung abbaut.
    - Sobald die Spannung reduziert ist, verbindet die Topoisomerase den geschnittenen Strang wieder, ohne dass Energie (ATP) benötigt wird.
...
- **Funktion**: Topoisomerase II entwirrt die DNA, indem sie **beide Stränge** der DNA-Doppelhelix schneidet.
- **Mechanismus**:
    - Die Topoisomerase Typ II schneidet **beide Stränge** eines DNA-Abschnitts.
    - Anschließend führt sie einen anderen Abschnitt der DNA durch die Lücke, die durch den Schnitt entstanden ist.
    ...
    - Dieser Prozess benötigt **ATP**, weil es mehr Energie erfordert, beide Stränge zu schneiden und zu rekonstruieren.
